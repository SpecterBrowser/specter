...
help :
	...
	@echo ""
	@echo "  all         - Make Specter source archive ${version}-${release}."
	@echo ""
	...
	@echo "                ready to build Specter folder."
	@echo "  build       - Build Specter (requires bootstrapped build environment)."
	@echo "  package     - Package Specter (requires build)."
	@echo "  run         - Run Specter (requires build)."
	@echo ""
	...
	@echo ""
	@echo "  patches   - Just make the Specter source directory (download, extract, patch)"
...
check :
	...
	@echo "Specter release : " $$(cat release)
	@echo ""
